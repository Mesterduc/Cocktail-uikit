...
struct Drink: Decodable {
    ...
    class Cocktail: NSObject, Decodable {
        let idDrink: String
        var strDrink: String
        let strTags: String?
